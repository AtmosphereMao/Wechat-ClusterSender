...
<head>
    ...
    {{--<link rel="stylesheet" type="text/css" href="{{asset('css/custom.css?version=1.0.0')}}" >--}}
    ...
    <link rel="stylesheet" type="text/css" href="{{url('css/loader.css?version=1.0.0')}}">
    <script type="text/javascript" src="{{url('jquery/jquery.min.js?version=1.0.0')}}"></script>
